...
<head>
	<title>GREEN GOLD EXPORTS LIMITED</title>
	<!-- Meta tag Keywords -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Green gold exports, annatto seeds, bixin, nor-bixin suppliers"
	/>
	<script>
...
<body>
	<div class="main-agile">
		...
		<div class="agile-top">
			<div class="col-xs-4 logo">
				...
				<h1>
					<a href="index.php">
						<span style="color: #61911e;">Green</span><span style="color: #dad14b">gold</span>
				</h1>
			</div>
			</div>
			<div class="col-xs-6 header-w3l">
				<ul>
					...
					<li>
						<a href="farmland.php">
							<span class="fa fa-pagelines" aria-hidden="true"></span> FARMLAND 
						</a>
					</li>
				</ul>
			</div>
			...
			<div class="col-xs-2 menu">
				...
				<nav>
					...
					<a href="farmland.php">Farmland</a>
					<a href="#annattoseeds" class="scroll">Processing</a>
			...
			<ul class="rslides callbacks callbacks1" id="slider4">
					...
					<div class="w3layouts-banner-top banner-3">
						<div class="container">
							<div class="agileits-banner-info">
								<h3>Viable seeds</h3>
								<p>We meet the highest quality standards internationally required
									<i class="fa fa-tree" aria-hidden="true"></i> Our seedlings are vigourous, fast growing and can resist pest and disease</p>
								<div class="video-pop-wthree">
									...
									<iframe width="560" height="315" src="https://www.youtube.com/embed/qIHQ0r7hqWI?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>									</div>
								</div>
				...
				<li>
					<div class="w3layouts-banner-top banner">
						<div class="container">
							<div class="agileits-banner-info">
								<h3>ANNATTO BIXIN AND NOR-BIXIN SUPPLIERS</h3>
								<p>We export annatto seeds to the United States markets
					...
					<div class="w3layouts-banner-top banner-2">
						<div class="container">
							<div class="agileits-banner-info">
								...
								<h3>OUR OWN FARMLANDS</h3>
								<p>Greengold exports limited has hectres of farmland here in Ghana.
									<i class="fa fa-tree" aria-hidden="true"></i> Our seeds are the most viable on the market</p>
								<!-- <div class="video-pop-wthree">
	...
	<div class="banner-bottom-w3l" id="about">
		<div class="container">
			<div class="title-div">
				...
				<p>This is official website of <span style="color: #61911e">Green</span><span style="color: #dad14b">gold</span> Exports Limited</p>
			</div>
			<div class="welcome-sub-wthree">
				<div class="col-md-12 banner_bottom_left">
					...
					<p>Greengold Exports was registered and incorporated in 2002 under the companies code in Ghana 1963(ACT 179)</p>
					<p>The main business line is agribusiness and exports of botanical products used in natural colors, spices and flavors industries</p>
					<span><a href="aboutus.php#about">Read more</a></span>
					<!-- <h6 class="w3l-style">Exports</h6> -->
				</div>
	...
	<!-- video section -->
	<div class="video-w3l" data-vide-bg="video/plantationvideo.mp4">
		<h5>HECTRES OF FARMLAND IN BRONG AHAFO REGION-GHANA</h5>
	...
	<!-- services -->
	<div class="agileits-services" id="annattoseeds">
		<div class="container">
			<div class="title-div">
				<h3 class="tittle">
					<span>A</span>nnatto
			...
			<div class="agileits-services-row">
				...
				<div class="col-md-5 banner_bottom_left">
					<h4>What are
						<span>Annatto seeds?</span>
					</h4>
					<p>Annatto seeds are popularly known as the lipstick tree because it is carotenoid with potent natural color pigment and also as a spice.</p>
					<p>The botanical name for annatto seed is Bixa Orellana. It belongs to the Bixaceae Family. Annatto seed is the raw
					material for processing natual Bixin and Bor-Bixin colors which is excellent source of natual edible colors. Annatto contan carotenoids and are used in food, cosmetic, pharmaceutical and beverage industries.</p>
					<span><a href="aboutus.php#annattoseeds">Read more</a></span>
					<!-- <h6 class="w3l-style">Exports</h6> -->
				</div>
				<!-- Stats-->
				<div class="col-md-7 stats-info-agile">
					<div class="w3l-right-stats">
						<div class="stats-grid stat-border">
							<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='728' data-delay='.5' data-increment="1">728</div>
							<p>Seedlings planted</p>
						</div>
						<div class="stats-grid">
							...
							<p>acre of farmland</p>
						</div>
						<div class="stats-grid stat-border border-st2">
							<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='120' data-delay='.5' data-increment="1">120</div>
							<p>Staff</p>
						</div>
					</div>
				</div>
	...
	<div class="agileits-services" id="services">
		<div class="container">
			<div class="title-div">
				<h3 class="tittle">
					<span>P</span>rocesses
				</h3>
				<div class="tittle-style">
				</div>
			</div>
			<div class="agileits-services-row">
				<div class="col-md-6 col-xs-6 agileits-services-grids">
					...
					<div class="clearfix"></div>
					<p>Viable seeds are planted in soil with necessary nutrient for annatto seed growth</p>
				...
				<div class="col-md-6 col-xs-6 agileits-services-grids">
					...
					<div class="clearfix"></div>
					<p></pViable seeds are planted in soil with necessary nutrient for annatto seed growth>
					<a href="#" data-toggle="modal" data-target="#myModal1" class="w3-buttons">Read More</a>
				</div>
				<div class="col-md-6 col-xs-6 agileits-services-grids">
					<div class="col-xs-3 wthree-ser">
	...
	<div class="contact" id="contact">
		...
		<div class="col-md-6 map">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1012463.1402743421!2d-1.9887694011778103!3d7.582148047616537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc5362494db3191%3A0x47795b5a0a2208d2!2sBrong+Ahafo+Region!5e0!3m2!1sen!2sgh!4v1527265171830" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
		<div class="col-md-6 address-left-second">
			<div class="address-grid">
				...
				<div class="address-grids">
					...
					<div class="contact-right">
						<p>Mail </p>
						<a href="mailto:greengold@gmail.com">greengold@gmail.com</a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="address-grids">
					...
					<div class="contact-right">
						<p>Location</p>
						<span>Brong Ahafo Region - Ghana | West Africa</span>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="address-grids">
		...
		<div class="container">
			...
			<div class="col-xs-9 ftr-menu">
				<ul>
					...
					<li>
						<a class="scroll" href="#services">Farmland</a>
					</li>
					<li>
			...
			<div class="copy-right">
				<p> &copy; 2018 Greengold Exports Limited | Design by
					<a href=""> Paperash</a>
				</p>
			</div>
		</div>
